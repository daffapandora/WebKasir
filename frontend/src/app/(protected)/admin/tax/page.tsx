...
export default function TaxPage() {
  ...
  const [configs, setConfigs] = useState(MOCK_TAX_CONFIGS);
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div className="flex items-center justify-between">
        <div><h1 className="text-2xl font-bold" style={{ color: 'var(--color-text-primary)' }}>Pajak & Service Charge</h1><p className="text-sm" style={{ color: 'var(--color-text-secondary)' }}>Konfigurasi pajak dan biaya layanan</p></div>
